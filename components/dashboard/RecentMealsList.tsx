...
import { RelativeTime } from '@/components/LocalDateTime'
...
export function RecentMealsList({ meals }: RecentMealsListProps) {
    if (meals.length === 0) {
        return (
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1 text-sm">
                            ...
                            <RelativeTime date={meal.logged_at} className="text-gray-500" />
                        </div>
                        {meal.calories !== null && (
